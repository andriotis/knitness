...
module.exports.usersIdEquipmentGET = function usersIdEquipmentGET (req, res, next, id) {
  Users.usersIdEquipmentGET(id)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.usersIdEquipmentPUT = function usersIdEquipmentPUT (req, res, next, body, id) {
  Users.usersIdEquipmentPUT(body, id)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.usersIdStatsGET = function usersIdStatsGET (req, res, next, id) {
  Users.usersIdStatsGET(id)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
